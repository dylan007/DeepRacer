...
def reward_function(params):
    ...
    rewards = dict.fromkeys(
        ['speed', 'heading', 'steering', 'progress', 'dist_racing_line'], 0.0)
    weights = dict.fromkeys(
        ['speed', 'heading', 'steering', 'progress', 'dist_racing_line'], 1000.0)
    weights['heading'] = 800.0
    weights['steering'] = 500.0
    weights['speed'] = 800.0
    weights['progress'] = 1000.0
    weights['dist_racing_line'] = 800.0
    ...
    distances.sort()
    rewards['dist_racing_line'] = (distances[0]/max_dist) * weights['dist_racing_line']
